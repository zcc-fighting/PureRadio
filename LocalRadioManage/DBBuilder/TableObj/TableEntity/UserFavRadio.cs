...
namespace LocalRadioManage.DBBuilder.TableObj
{
    class UserFavRadio
    {
        ...
        public readonly static string[] ForeignKey_1 = { ChannalAlbumId[0], UserFavChannalAlbum.TableName, UserFavChannalAlbum.ChannalAlbumId[0], TableInform.FOREIGN_CASCADE };
