...
namespace PureRadio.LocalRadioManage.Adapter
{
    ...
    {
        public static DataModels.LocalUserInform UserProfileToUserInform(AccountInfo user_pro)
        {
        ...
        public static AccountInfo UserInformToUserProfile(DataModels.LocalUserInform local)
        {
